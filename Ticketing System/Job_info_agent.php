...
<div class="container">
    ...
    <form action="ticket_get.php" name="ticket_form" enctype="multipart/form-data" method="post" onsubmit="return ticketFormValidate()" class="form-horizontal" role="form">
        ...
        <div class="form-group" id="client_first_name">
            ...
            <div class="col-sm-9">
                <input maxlength="30" type="text"  class="form-control" disabled name="client_first_name" id="client_first_name" value="$sClient_First_Name" Placeholder="Enter the clients name...">
            </div>
        </div>
        <div class="form-group" id="client_last_name">
            <label class="col-sm-3" for="client_last_name">Client Surname :</label>
            <div class="col-sm-9">
                <input maxlength="30" type="text"  class="form-control" disabled name="client_last_name" id="client_last_name" value="$sClient_Second_Name" Placeholder="Enter the clients surname..">
            </div>
        </div>
        <div class="form-group" id="client_email">
            <label class="col-sm-3" for="client_email">Client Email :</label>
            <div class="col-sm-9">
                <input maxlength="30" type="email"  class="form-control" disabled name="client_email" id="client_email" value="$sEmail" Placeholder="Enter the clients email...">
            </div>
        </div>
        <div class="form-group" id="client_phone_number">
            <label class="col-sm-3" for="client_phone_number">Client Phone Number :</label>
            <div class="col-sm-9">
                <input maxlength="30" type="text"  class="form-control" disabled name="client_phone_number" id="client_phone_number" value="$sPhonenumber" Placeholder="Enter the clients phone number...">
            </div>
        </div>
        ...
        <div class="form-group" id="location">
            ...
            <div class="col-sm-9">
                <input maxlength="30" autocomplete="off" disabled type="text" class="form-control" name="location" value="$sLocation" placeholder="Enter a location for your ticket...">
            </div>
        </div>
        <div class="form-group" id="location_dropdown" style="display:none">
            ...
            <div class="col-sm-9">
                <select class="form-control" disabled id="location_dropdown" name="location_dropdown">
                    $sGivenLocation
                </select>
            </div>
        </div>
